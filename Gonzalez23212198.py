...
Nombre del alumno: Martin Alonso Gonzalez Holguin
Número de control: 23212198
Correo institucional: l23212198@tectijuana.edu.mx
...
print(f"Capacitancia Ce: {Ce:.3e} Faradios\n")
